...
using Touride.IdentityPlatform.Admin.IdentityServer.Services.Services;
...
using Touride.IdentityPlatform.Admin.UI.Configuration.ApplicationParts;
using Touride.IdentityPlatform.Admin.UI.Configuration.Constants;
using Touride.IdentityPlatform.Admin.UI.ExceptionHandling;
using Touride.IdentityPlatform.Admin.UI.Helpers.Localization;
...
using Touride.IdentityPlatform.Data.Providers.SqlServer;
using Touride.IdentityPlatform.Data.Repositories;
using Touride.IdentityPlatform.Data.Repositories.Interfaces;
using Touride.IdentityPlatform.IdentityServer.Common.Authentication;

namespace Touride.IdentityPlatform.Admin.Web.Helpers
{
