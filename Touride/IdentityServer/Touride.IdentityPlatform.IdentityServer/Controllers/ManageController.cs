...
using Touride.IdentityPlatform.IdentityServer.ViewModels.Manage;

namespace Touride.IdentityPlatform.IdentityServer.Controllers
{
    [Authorize]
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("Touride.IdentityPlatform.IdentityServer"),
