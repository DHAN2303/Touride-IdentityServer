...
using Touride.IdentityPlatform.Data.Configuration.Configuration;
...
using Touride.IdentityPlatform.IdentityServer.Configuration.ApplicationParts;
using Touride.IdentityPlatform.IdentityServer.Configuration.Constants;
using Touride.IdentityPlatform.IdentityServer.Configuration.Interfaces;
using Touride.IdentityPlatform.IdentityServer.Helpers.Localization;

namespace Touride.IdentityPlatform.IdentityServer.Helpers
{
