...
using SendGrid;
using System;
using Touride.IdentityPlatform.IdentityServer.Common.Configuration.Common;
using Touride.IdentityPlatform.IdentityServer.Common.Configuration.Email;
using Touride.IdentityPlatform.IdentityServer.Common.Configuration.Email;
using Touride.IdentityPlatform.IdentityServer.Common.Email;

namespace Touride.IdentityPlatform.IdentityServer.Common.Helpers
{
